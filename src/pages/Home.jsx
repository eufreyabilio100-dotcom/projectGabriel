...
export default function Home() {
  ...
  return (
    <div onMouseMove={handleMouseMove}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ScrollReveal delay={100}>
              <div className="text-center p-8 rounded-xl bg-gray-50 hover:bg-primary-50 transition-all duration-300 hover:-translate-y-2 hover:shadow-lg group cursor-pointer">
                <div className="bg-primary-100 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-primary-200 group-hover:rotate-6 transition-all">
            ...
            <ScrollReveal delay={200}>
              <div className="text-center p-8 rounded-xl bg-gray-50 hover:bg-secondary-50 transition-all duration-300 hover:-translate-y-2 hover:shadow-lg group cursor-pointer">
                <div className="bg-secondary-100 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-secondary-200 group-hover:rotate-6 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { step: 2, title: 'Escolha um Evento', desc: 'Explore os eventos disponíveis e encontre o ideal', icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z' },
              ...
              <ScrollReveal key={i} delay={i * 150}>
                <div className="relative text-center group">
                  <div className="bg-primary-600 text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold group-hover:scale-110 transition-transform">
                    {item.step}
                  </div>
                  {i < 2 && (
                    <div className="hidden md:block absolute top-6 left-[calc(50%+2rem)] w-[calc(100%-4rem)] h-0.5 bg-primary-200" />
                  )}
                  <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    <svg className="w-12 h-12 text-primary-600 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-primary-600 to-primary-800 py-20 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-1/4 w-64 h-64 bg-white rounded-full blur-3xl" />
          <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-secondary-400 rounded-full blur-3xl" />
        </div>
