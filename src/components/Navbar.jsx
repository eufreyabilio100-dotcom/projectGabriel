            ...
            {user ? (
              <>
                ...
                <div className="flex items-center space-x-3 ml-2">
                  <Link to="/perfil" className="text-sm text-primary-200 hover:text-white transition-colors flex items-center gap-1" title="Meu Perfil">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                    <span className="hidden lg:inline">{user.user_metadata?.nome || 'Meu Perfil'}</span>
                  </Link>
                  <button
              ...
              <>
                ...
                <div className="px-3 py-2">
                  <Link to="/perfil" className="flex items-center gap-2 text-sm text-primary-200 hover:text-white mb-2 transition-colors">
                    ...
                    {user.user_metadata?.nome || 'Meu Perfil'}
                  </Link>
                  <button
                    onClick={handleLogout}
